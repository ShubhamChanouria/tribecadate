    ...
    return (
        <div className=' md:w-[80%] my-12 mx-auto'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                    <h3 className='text-subheading-mobile md:text-subheading-mobile lg:text-subheading font-semibold '>Tribeca Date is New York{`'`}s most exclusive network, bringing together accomplished, attractive young tech founders with winning personalities, seeking the perfect partner.
                    </h3>
            ...
            <h3 className='text-subheading-mobile md:text-subheading-mobile lg:text-subheading font-semibold  '>Are you eligible for Tribeca Date Club?</h3>
